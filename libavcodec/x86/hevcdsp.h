...
//#ifdef SVC_EXTENSION
//void ff_upsample_base_layer_frame_sse(struct AVFrame *FrameEL, struct AVFrame *FrameBL, short *Buffer[3], struct HEVCWindow *Enhscal, struct UpsamplInf *up_info, int channel);
