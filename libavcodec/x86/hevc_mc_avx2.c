...
void ff_hevc_put_hevc_pel_pixels ## H ## _ ## D ## _avx2 (                      \
...
void ff_hevc_put_hevc_bi_pel_pixels ## H ## _ ## D ## _avx2 (                   \
...
void ff_hevc_put_hevc_uni_pel_pixels ## H ## _ ## D ## _avx2 (                  \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_pel_pixels ## H ## _ ## D ## _avx2 (                \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
...
void ff_hevc_put_hevc_bi_w_pel_pixels ## H ## _ ## D ## _avx2 (                     \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
...
void ff_hevc_put_hevc_epel_h ## H ## _ ## D ## _avx2 (                          \
        int16_t *dst, ptrdiff_t dststride,                                     \
        uint8_t *_src, ptrdiff_t _srcstride,                                   \
        int height,                                                            \
        intptr_t mx, intptr_t my, int width) {                                 \
...
void ff_hevc_put_hevc_bi_epel_h ## H ## _ ## D ## _avx2 (                       \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height,                 \
...
void ff_hevc_put_hevc_uni_epel_h ## H ## _ ## D ## _avx2 (                      \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_epel_h ## H ## _ ## D ## _avx2 (                    \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int _wx, int _ox,                          \
...
void ff_hevc_put_hevc_bi_w_epel_h ## H ## _ ## D ## _avx2 (                     \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height, int denom, int _wx0,       \
...
void ff_hevc_put_hevc_epel_v ## H ## _ ## D ## _avx2 (                          \
        int16_t *dst, ptrdiff_t dststride,                                     \
        uint8_t *_src, ptrdiff_t _srcstride,                                   \
        int height,                                                            \
        intptr_t mx, intptr_t my, int width) {                                 \
...
void ff_hevc_put_hevc_bi_epel_v ## H ## _ ## D ## _avx2 (                       \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height,                 \
...
void ff_hevc_put_hevc_uni_epel_v ## H ## _ ## D ## _avx2 (                      \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_epel_v ## H ## _ ## D ## _avx2 (                    \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int _wx, int _ox,                          \
...
void ff_hevc_put_hevc_bi_w_epel_v ## H ## _ ## D ## _avx2 (                     \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height, int denom, int _wx0,       \
...
void ff_hevc_put_hevc_epel_hv ## H ## _ ## D ## _avx2 (                         \
        int16_t *dst, ptrdiff_t dststride,                                     \
        uint8_t *_src, ptrdiff_t _srcstride,                                   \
        int height,                                                            \
        intptr_t mx, intptr_t my, int width) {                                 \
...
void ff_hevc_put_hevc_bi_epel_hv ## H ## _ ## D ## _avx2 (                      \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height,                 \
...
void ff_hevc_put_hevc_uni_epel_hv ## H ## _ ## D ## _avx2 (                     \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_epel_hv ## H ## _ ## D ## _avx2 (                   \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int _wx, int _ox,                      \
...
void ff_hevc_put_hevc_bi_w_epel_hv ## H ## _ ## D ## _avx2 (                    \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height, int denom, int _wx0,       \
...
void ff_hevc_put_hevc_qpel_h ## H ## _ ## D ## _avx2 (                          \
                                    int16_t *dst, ptrdiff_t dststride,         \
                                    uint8_t *_src, ptrdiff_t _srcstride,       \
...
void ff_hevc_put_hevc_bi_qpel_h ## H ## _ ## D ## _avx2 (                       \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height,                            \
...
void ff_hevc_put_hevc_uni_qpel_h ## H ## _ ## D ## _avx2 (                      \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_qpel_h ## H ## _ ## D ## _avx2 (                    \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int _wx, int _ox,                      \
...
void ff_hevc_put_hevc_bi_w_qpel_h ## H ## _ ## D ## _avx2 (                     \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height, int denom, int _wx0,       \
...
void ff_hevc_put_hevc_qpel_v ## V ## _ ## D ## _avx2 (                          \
                                    int16_t *dst, ptrdiff_t dststride,         \
                                    uint8_t *_src, ptrdiff_t _srcstride,       \
                                    int height, intptr_t mx, intptr_t my, int width) {   \
    int x, y;                                                                  \
...
void ff_hevc_put_hevc_bi_qpel_v ## V ## _ ## D ## _avx2 (                       \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height,                 \
...
void ff_hevc_put_hevc_uni_qpel_v ## V ## _ ## D ## _avx2 (                      \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_qpel_v ## V ## _ ## D ## _avx2 (                    \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int _wx, int _ox,                          \
...
void ff_hevc_put_hevc_bi_w_qpel_v ## V ## _ ## D ## _avx2 (                     \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height, int denom, int _wx0,       \
...
void ff_hevc_put_hevc_bi_qpel_v ## V ## _14_ ## D ## _avx2 (                    \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height,                 \
...
void ff_hevc_put_hevc_uni_qpel_v ## V ## _14_ ## D ## _avx2 (                   \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_qpel_v ## V ## _14_ ## D ## _avx2 (                 \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int _wx, int _ox,                      \
...
void ff_hevc_put_hevc_qpel_hv ## H ## _ ## D ## _avx2 (                         \
        int16_t *dst, ptrdiff_t dststride,                                     \
        uint8_t *_src, ptrdiff_t _srcstride,                                   \
        int height,                                                            \
        intptr_t mx, intptr_t my, int width) {                                 \
...
DECLARE_ALIGNED(32, int16_t, tmp_array[(MAX_PB_SIZE + QPEL_EXTRA) * MAX_PB_SIZE];)              \
    ...
    ff_hevc_put_hevc_qpel_h ## H ## _ ## D ## _avx2(                            \
        tmp, MAX_PB_SIZE, (uint8_t *)src, _srcstride, height + QPEL_EXTRA, mx, my, width); \
    tmp    = tmp_array + QPEL_EXTRA_BEFORE * MAX_PB_SIZE;                      \
    ff_hevc_put_hevc_uni_qpel_v ## H ## _14_ ## D ## _avx2(                     \
        dst, dststride, (uint8_t *) tmp, MAX_PB_SIZE <<1 , height, mx, my, width);\
}

#define PUT_HEVC_UNI_W_QPEL_HV(H, D)                                           \
void ff_hevc_put_hevc_uni_w_qpel_hv ## H ## _ ## D ## _avx2 (                   \
                                        uint8_t *dst, ptrdiff_t dststride,     \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int wx, int ox,                        \
...
void ff_hevc_put_hevc_bi_w_qpel_hv ## H ## _ ## D ## _avx2 (                    \
    ...
    ff_hevc_put_hevc_qpel_h ## H ## _ ## D ## _avx2(                            \
        tmp, MAX_PB_SIZE, (uint8_t *)src, _srcstride, height + QPEL_EXTRA, mx, my, width); \
    tmp    = tmp_array + QPEL_EXTRA_BEFORE * MAX_PB_SIZE;                      \
    ff_hevc_put_hevc_bi_w_qpel_v ## H ## _14_ ## D ## _avx2(                    \
...
void ff_hevc_put_hevc_qpel_h16_8_avx2 (
                                    int16_t *dst, ptrdiff_t dststride,         
                                    uint8_t *_src, ptrdiff_t _srcstride,       
                                    int height, intptr_t mx, intptr_t my, int width) {   
    int x, y, k;
...
void ff_hevc_put_hevc_bi_qpel_h16_8_avx2 (                       \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height,                            \
...
void ff_hevc_put_hevc_uni_qpel_h16_8_avx2 (                      \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height,                            \
                                        intptr_t mx, intptr_t my, int width) { \
...
void ff_hevc_put_hevc_uni_w_qpel_h16_8_avx2 (                    \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int height, int denom,                 \
                                        int _wx, int _ox,                      \
...
void ff_hevc_put_hevc_bi_w_qpel_h16_8_avx2 (                     \
                                        uint8_t *_dst, ptrdiff_t _dststride,   \
                                        uint8_t *_src, ptrdiff_t _srcstride,   \
                                        int16_t *src2, ptrdiff_t src2stride,   \
                                        int height, int denom, int _wx0,       \
...
void ff_hevc_put_hevc_uni_w_##name##W##_##bitd##_avx2(                                                       \
    ...
    ff_hevc_put_hevc_uni_w_##name##step##_##bitd##_avx2(dst, dststride, _src, _srcstride, height, denom, wx, ox, mx, my, width);\
}                                                                                                           \
