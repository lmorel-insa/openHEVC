...
#ifdef SVC_EXTENSION
    hevcdsp->upsample_base_layer_frame       = ff_upsample_base_layer_frame_sse; \
    hevcdsp->upsample_filter_block_luma_h[0] = ff_upsample_filter_block_luma_h_ALL_sse; \
    hevcdsp->upsample_filter_block_luma_h[1] = ff_upsample_filter_block_luma_h_X2_sse; \
    hevcdsp->upsample_filter_block_luma_h[2] = ff_upsample_filter_block_luma_h_X1_5_sse; \
    hevcdsp->upsample_filter_block_luma_v[0] = ff_upsample_filter_block_luma_v_ALL_sse; \
    hevcdsp->upsample_filter_block_luma_v[1] = ff_upsample_filter_block_luma_v_X2_sse; \
    hevcdsp->upsample_filter_block_luma_v[2] = ff_upsample_filter_block_luma_v_X1_5_sse; \
    hevcdsp->upsample_filter_block_cr_h[0]   = ff_upsample_filter_block_cr_h_ALL_sse; \
    hevcdsp->upsample_filter_block_cr_h[1]   = ff_upsample_filter_block_cr_h_X2_sse; \
    hevcdsp->upsample_filter_block_cr_h[2]   = ff_upsample_filter_block_cr_h_X1_5_sse; \
    hevcdsp->upsample_filter_block_cr_v[0]   = ff_upsample_filter_block_cr_v_ALL_sse; \
    hevcdsp->upsample_filter_block_cr_v[1]   = ff_upsample_filter_block_cr_v_X2_sse; \
    hevcdsp->upsample_filter_block_cr_v[2]   = ff_upsample_filter_block_cr_v_X1_5_sse; \
#endif
