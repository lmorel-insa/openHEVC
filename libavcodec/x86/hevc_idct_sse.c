...
TRANSFORM2(16,  8);
TRANSFORM2(16, 10);
void ff_hevc_transform_16x16_10_avx2 (
                                      int16_t *coeffs, int col_limit) {
    int i, j, k, add;
    int      shift = 7;
    int16_t *src   = coeffs;
    ...
    for (k = 0; k < 2; k++) {
        ...
        for (i = 0; i < 16; i+=8) {
            p_dst = tmp + i;
            {
                int i;
                int o16[8*8];
                tmp0 = _mm_load_si128((__m128i *) &src[1 * 16]);
                tmp1 = _mm_load_si128((__m128i *) &src[3 * 16]);
                tmp2 = _mm_load_si128((__m128i *) &src[5 * 16]);
                tmp3 = _mm_load_si128((__m128i *) &src[7 * 16]);
                e0 = _mm_unpacklo_epi16(tmp0, tmp1);
                e1 = _mm_unpackhi_epi16(tmp0, tmp1);
                e2 = _mm_unpacklo_epi16(tmp2, tmp3);
                e3 = _mm_unpackhi_epi16(tmp2, tmp3);
                tmp0 = _mm_load_si128((__m128i *) &src[ 9 * 16]);
                tmp1 = _mm_load_si128((__m128i *) &src[11 * 16]);
                tmp2 = _mm_load_si128((__m128i *) &src[13 * 16]);
                tmp3 = _mm_load_si128((__m128i *) &src[15 * 16]);
                e4 = _mm_unpacklo_epi16(tmp0, tmp1);
                e5 = _mm_unpackhi_epi16(tmp0, tmp1);
                e6 = _mm_unpacklo_epi16(tmp2, tmp3);
                e7 = _mm_unpackhi_epi16(tmp2, tmp3);
                for (i = 0; i < 8; i++) {
                    tmp1 = _mm_load_si128((__m128i *) transform16x16_1[0  ][i]);
                    tmp3 = _mm_load_si128((__m128i *) transform16x16_1[0+1][i]);
                    tmp0 = _mm_madd_epi16(e0, tmp1);
                    tmp1 = _mm_madd_epi16(e1, tmp1);
                    tmp2 = _mm_madd_epi16(e2, tmp3);
                    tmp3 = _mm_madd_epi16(e3, tmp3);
                    src0 = _mm_add_epi32(tmp0, tmp2);
                    src1 = _mm_add_epi32(tmp1, tmp3);
                    tmp1 = _mm_load_si128((__m128i *) transform16x16_1[2  ][i]);
                    tmp3 = _mm_load_si128((__m128i *) transform16x16_1[2+1][i]);
                    tmp0 = _mm_madd_epi16(e4, tmp1);
                    tmp1 = _mm_madd_epi16(e5, tmp1);
                    tmp2 = _mm_madd_epi16(e6, tmp3);
                    tmp3 = _mm_madd_epi16(e7, tmp3);
                    tmp0 = _mm_add_epi32(tmp0, tmp2);
                    tmp1 = _mm_add_epi32(tmp1, tmp3);
                    src0 = _mm_add_epi32(src0, tmp0);
                    src1 = _mm_add_epi32(src1, tmp1);
                    _mm_store_si128((__m128i *) &o16[i*8]  , src0);
                    _mm_store_si128((__m128i *) &o16[i*8+4], src1);
                }
                src0 = _mm_load_si128((__m128i *) &src[0 * 2 * 2 * 16]);
                src1 = _mm_load_si128((__m128i *) &src[1 * 2 * 2 * 16]);
                src2 = _mm_load_si128((__m128i *) &src[2 * 2 * 2 * 16]);
                src3 = _mm_load_si128((__m128i *) &src[3 * 2 * 2 * 16]);
                e6 = _mm_unpacklo_epi16(src0, src2);
                e7 = _mm_unpacklo_epi16(src1, src3);
                tmp0 = _mm_load_si128((__m128i *) transform4x4[0]);
                tmp1 = _mm_load_si128((__m128i *) transform4x4[1]);
                ...
                tmp0 = _mm_add_epi32(tmp0, e6);
                tmp1 = _mm_add_epi32(tmp1, e6);
                e7 = _mm_add_epi32(tmp0, tmp2);
                e6 = _mm_add_epi32(tmp1, tmp3);
                e5 = _mm_sub_epi32(tmp1, tmp3);
                e4 = _mm_sub_epi32(tmp0, tmp2);
                tmp0 = _mm_load_si128((__m128i *) &src[1 * 2 * 16]);
                tmp1 = _mm_load_si128((__m128i *) &src[3 * 2 * 16]);
                tmp2 = _mm_load_si128((__m128i *) &src[5 * 2 * 16]);
                tmp3 = _mm_load_si128((__m128i *) &src[7 * 2 * 16]);
                src0 = _mm_unpacklo_epi16(tmp0, tmp1);
                src1 = _mm_unpackhi_epi16(tmp0, tmp1);
                src2 = _mm_unpacklo_epi16(tmp2, tmp3);
                src3 = _mm_unpackhi_epi16(tmp2, tmp3);
                tmp1 = _mm_load_si128((__m128i *) transform8x8[0  ][0]);
                tmp3 = _mm_load_si128((__m128i *) transform8x8[0+1][0]);
                tmp0 = _mm_madd_epi16(src0, tmp1);
                tmp1 = _mm_madd_epi16(src1, tmp1);
                tmp2 = _mm_madd_epi16(src2, tmp3);
                tmp3 = _mm_madd_epi16(src3, tmp3);
                ...
                tmp0 = _mm_add_epi32(e0, tmp2);
                tmp1 = _mm_add_epi32(e7, tmp3);
                tmp3 = _mm_sub_epi32(e7, tmp3);
                tmp2 = _mm_sub_epi32(e0, tmp2);
                e0   = _mm_load_si128((__m128i *) &o16[0*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[0*8+4]);
                tmp4 = _mm_add_epi32(tmp0, e0);
                tmp0 = _mm_sub_epi32(tmp0, e0);
                e0   = _mm_add_epi32(tmp1, e7);
                tmp1 = _mm_sub_epi32(tmp1, e7);
                tmp4 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp4), (shift)));
                e0 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(e0), (shift)));
                e0 = _mm_packs_epi32(tmp4, e0);
                tmp0 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp0), (shift)));
                tmp1 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp1), (shift)));
                e7 = _mm_packs_epi32(tmp0, tmp1);
                _mm_store_si128((__m128i *) &p_dst[16*(             0)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-0)]  , e7);
                e0   = _mm_load_si128((__m128i *) &o16[7*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[7*8+4]);
                tmp4 = _mm_add_epi32(tmp2, e0);
                tmp2 = _mm_sub_epi32(tmp2, e0);
                e0   = _mm_add_epi32(tmp3, e7);
                tmp3 = _mm_sub_epi32(tmp3, e7);
                tmp4 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp4), (shift)));
                e0 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(e0), (shift)));
                e0 = _mm_packs_epi32(tmp4, e0);
                tmp2 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp2), (shift)));
                tmp3 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp3), (shift)));
                e7 = _mm_packs_epi32(tmp2, tmp3);
                _mm_store_si128((__m128i *) &p_dst[16*(             7)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-7)]  , e7);
                tmp1 = _mm_load_si128((__m128i *) transform8x8[2  ][0]);
                tmp3 = _mm_load_si128((__m128i *) transform8x8[2+1][0]);
                tmp0 = _mm_madd_epi16(src0, tmp1);
                tmp1 = _mm_madd_epi16(src1, tmp1);
                tmp2 = _mm_madd_epi16(src2, tmp3);
                tmp3 = _mm_madd_epi16(src3, tmp3);
                tmp2 = _mm_add_epi32(tmp0, tmp2);
                tmp3 = _mm_add_epi32(tmp1, tmp3);
                tmp0 = _mm_add_epi32(e1, tmp2);
                tmp1 = _mm_add_epi32(e6, tmp3);
                tmp3 = _mm_sub_epi32(e6, tmp3);
                tmp2 = _mm_sub_epi32(e1, tmp2);
                e0   = _mm_load_si128((__m128i *) &o16[1*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[1*8+4]);
                tmp4 = _mm_add_epi32(tmp0, e0);
                tmp0 = _mm_sub_epi32(tmp0, e0);
                e0   = _mm_add_epi32(tmp1, e7);
                tmp1 = _mm_sub_epi32(tmp1, e7);
                ...
                tmp1 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp1), (shift)));
                e7 = _mm_packs_epi32(tmp0, tmp1);
                _mm_store_si128((__m128i *) &p_dst[16*(             1)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-1)]  , e7);
                e0   = _mm_load_si128((__m128i *) &o16[6*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[6*8+4]);
                tmp4 = _mm_add_epi32(tmp2, e0);
                tmp2 = _mm_sub_epi32(tmp2, e0);
                e0   = _mm_add_epi32(tmp3, e7);
                tmp3 = _mm_sub_epi32(tmp3, e7);
                ...
                tmp3 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp3), (shift)));
                e7 = _mm_packs_epi32(tmp2, tmp3);
                _mm_store_si128((__m128i *) &p_dst[16*(             6)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-6)]  , e7);
                tmp1 = _mm_load_si128((__m128i *) transform8x8[4  ][0]);
                tmp3 = _mm_load_si128((__m128i *) transform8x8[4+1][0]);
                tmp0 = _mm_madd_epi16(src0, tmp1);
                tmp1 = _mm_madd_epi16(src1, tmp1);
                tmp2 = _mm_madd_epi16(src2, tmp3);
                tmp3 = _mm_madd_epi16(src3, tmp3);
                tmp2 = _mm_add_epi32(tmp0, tmp2);
                tmp3 = _mm_add_epi32(tmp1, tmp3);\
                tmp0 = _mm_add_epi32(e2, tmp2);
                tmp1 = _mm_add_epi32(e5, tmp3);
                tmp3 = _mm_sub_epi32(e5, tmp3);
                tmp2 = _mm_sub_epi32(e2, tmp2);
                e0   = _mm_load_si128((__m128i *) &o16[2*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[2*8+4]);
                tmp4 = _mm_add_epi32(tmp0, e0);
                tmp0 = _mm_sub_epi32(tmp0, e0);
                e0   = _mm_add_epi32(tmp1, e7);
                tmp1 = _mm_sub_epi32(tmp1, e7);
                ...
                tmp1 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp1), (shift)));
                e7 = _mm_packs_epi32(tmp0, tmp1);
                _mm_store_si128((__m128i *) &p_dst[16*(             2)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-2)]  , e7);
                e0   = _mm_load_si128((__m128i *) &o16[5*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[5*8+4]);
                tmp4 = _mm_add_epi32(tmp2, e0);
                tmp2 = _mm_sub_epi32(tmp2, e0);
                e0   = _mm_add_epi32(tmp3, e7);
                tmp3 = _mm_sub_epi32(tmp3, e7);
                ...
                tmp3 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp3), (shift)));
                e7 = _mm_packs_epi32(tmp2, tmp3);
                _mm_store_si128((__m128i *) &p_dst[16*(             5)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-5)]  , e7);
                tmp1 = _mm_load_si128((__m128i *) transform8x8[6  ][0]);
                tmp3 = _mm_load_si128((__m128i *) transform8x8[6+1][0]);
                tmp0 = _mm_madd_epi16(src0, tmp1);
                tmp1 = _mm_madd_epi16(src1, tmp1);
                tmp2 = _mm_madd_epi16(src2, tmp3);
                tmp3 = _mm_madd_epi16(src3, tmp3);
                tmp2 = _mm_add_epi32(tmp0, tmp2);
                tmp3 = _mm_add_epi32(tmp1, tmp3);\
                tmp0 = _mm_add_epi32(e3, tmp2);
                tmp1 = _mm_add_epi32(e4, tmp3);
                tmp3 = _mm_sub_epi32(e4, tmp3);
                tmp2 = _mm_sub_epi32(e3, tmp2);
                e0   = _mm_load_si128((__m128i *) &o16[3*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[3*8+4]);
                tmp4 = _mm_add_epi32(tmp0, e0);
                tmp0 = _mm_sub_epi32(tmp0, e0);
                e0   = _mm_add_epi32(tmp1, e7);
                tmp1 = _mm_sub_epi32(tmp1, e7);
                ...
                tmp1 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp1), (shift)));
                e7 = _mm_packs_epi32(tmp0, tmp1);
                _mm_store_si128((__m128i *) &p_dst[16*(             3)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-3)]  , e7);
                e0   = _mm_load_si128((__m128i *) &o16[4*8+0]);
                e7   = _mm_load_si128((__m128i *) &o16[4*8+4]);
                tmp4 = _mm_add_epi32(tmp2, e0);
                tmp2 = _mm_sub_epi32(tmp2, e0);
                e0   = _mm_add_epi32(tmp3, e7);
                tmp3 = _mm_sub_epi32(tmp3, e7);
                ...
                tmp3 = ((__m128i)__builtin_ia32_psradi128 ((__v8hi)(tmp3), (shift)));
                e7 = _mm_packs_epi32(tmp2, tmp3);
                _mm_store_si128((__m128i *) &p_dst[16*(             4)]  , e0);
                _mm_store_si128((__m128i *) &p_dst[16*(16-1-4)]  , e7);;
            };
            src   += 8;
            for (j = 0; j < 16; j+=8) {
                e0  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[0*16]);
                e1  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[1*16]);
                e2  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[2*16]);
                e3  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[3*16]);
                e4  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[4*16]);
                e5  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[5*16]);
                e6  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[6*16]);
                e7  = _mm_load_si128((__m128i *) &(&tmp[j*16+i])[7*16]);
                tmp0 = _mm_unpacklo_epi16(e0, e1);
                tmp1 = _mm_unpacklo_epi16(e2, e3);
                tmp2 = _mm_unpacklo_epi16(e4, e5);
                tmp3 = _mm_unpacklo_epi16(e6, e7);
                src0 = _mm_unpacklo_epi32(tmp0, tmp1);                                    
                src1 = _mm_unpacklo_epi32(tmp2, tmp3);                                    
                src2 = _mm_unpackhi_epi32(tmp0, tmp1);                                    
                src3 = _mm_unpackhi_epi32(tmp2, tmp3);                                    
                tmp0 = _mm_unpackhi_epi16(e0, e1);                            
                tmp1 = _mm_unpackhi_epi16(e2, e3);                            
                tmp2 = _mm_unpackhi_epi16(e4, e5);                            
                tmp3 = _mm_unpackhi_epi16(e6, e7);                            
                e0 = _mm_unpacklo_epi64(src0 , src1);                               
                e1 = _mm_unpackhi_epi64(src0 , src1);                               
                e2 = _mm_unpacklo_epi64(src2 , src3);                               
                e3 = _mm_unpackhi_epi64(src2 , src3);                               
                src0 = _mm_unpacklo_epi32(tmp0, tmp1);                                    
                src1 = _mm_unpacklo_epi32(tmp2, tmp3);                                    
                src2 = _mm_unpackhi_epi32(tmp0, tmp1);                                    
                src3 = _mm_unpackhi_epi32(tmp2, tmp3);                                    
                e4 = _mm_unpacklo_epi64(src0 , src1);                               
                e5 = _mm_unpackhi_epi64(src0 , src1);                               
                e6 = _mm_unpacklo_epi64(src2 , src3);                               
                e7 = _mm_unpackhi_epi64(src2 , src3);                                                     
                p_dst = (&p_tra[i*16+j]);                                                              
                _mm_store_si128((__m128i *) p_dst, e0);                                   
                p_dst += 16;                                            
                _mm_store_si128((__m128i *) p_dst, e1);                                   
                p_dst += 16;                                            
                _mm_store_si128((__m128i *) p_dst, e2);                                   
                p_dst += 16;                                            
                _mm_store_si128((__m128i *) p_dst, e3);                                   
                p_dst += 16;                                
                _mm_store_si128((__m128i *) p_dst, e4);                                   
                p_dst += 16;                                            
                _mm_store_si128((__m128i *) p_dst, e5);                                   
                p_dst += 16;                                            
                _mm_store_si128((__m128i *) p_dst, e6);                                   
                p_dst += 16;                                            
                _mm_store_si128((__m128i *) p_dst, e7);                                   
                p_dst += 16;\
            }                                                                 
        }                                                                     
        src   = tmp_2;                                                        
